...
a) Laden Sie den Datensatz `taylor_swift_spotify.csv` in Ihre R-Session. Nennen Sie Ihr Datenframe dabei `ts`.
...
h) Plotten Sie die Anzahl der Tracks pro Album als Liniendiagramm, wobei das Datum auf der X-Achse, und die Trackanzahl auf der Y-Achse dargestellt werden.
:::
