...
::: {.callout-note appearance="simple"}
Im Datensatz `Krankenhaus.RData`^[siehe <https://www.produnis.de/R/data/Krankenhaus.RData>] sind die Aufnahme- und Entlassungsdaten von Patienten eines Krankenhauses enthalten.
...
p) Unterscheiden sich Männer und Frauen hinsichtlich der Liegedauer? Stellen Sie den Unterschied ebenfalls tabellarisch und graphisch dar.
q) Ist der Unterschied der Liegedauer zwischen Männern und Frauen signifikant?
