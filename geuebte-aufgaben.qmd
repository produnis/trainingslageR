...
a) Laden Sie den Datensatz als `data.table` von <https://www.produnis.de/R/data/rolling_stone.csv> in Ihre R-Session, und machen Sie sich mit den Daten vertraut.
